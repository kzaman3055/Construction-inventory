                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Name</label>
                                                                <div class="controls">
                                                                    <input type="text" name="name" class="form-control" value="{{ !empty($editdata->name) ? $editdata->name : '' }}" required placeholder="Enter Name">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="suppliers_id" class="form-control select2" style="width: 100%;" required>
                                                                    <option value="" selected="selected" disabled="">Select Supplier</option>
                                                                    @foreach ($supplierdata as $key => $supplier)
                                                                        @if ($supplier->status == 1)
                                                                            <option value="{{ $supplier->id }}" {{ $supplier->id == $editdata->suppliers_id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                                                                        @endif
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="unit_id" class="form-control select2" style="width: 100%;" required>
                                                                    ...
                                                                    @foreach ($unitdata as $key => $unit)
                                                                        <option value="{{ $unit->id }}" {{ $unit->id == $editdata->unit_id ? 'selected' : '' }}>{{ $unit->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
