            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="page-header">
                  <h2 class="d-inline"><span class="font-size-30">Purchase Invoice</span></h2>
                  <div class="pull-right text-right">
                                                       @foreach ($purchaseinvoice as $key => $purchaseinvoice)
                      <h3>                                                      {{ \Carbon\Carbon::parse($purchaseinvoice->updated_at)->format('h:i A d-m-Y') }}
                      </h3>
                      @endforeach
                  </div>
                </div>
              ...
              <div class="col-sm-12 invoice-col mb-15">
                  <div class="invoice-details row no-margin">
                    <div class="col-md-6 col-lg-3"><b>Invoice </b>
                        {{ $purchaseinvoice->invoice_code }}
                    </div>
                    <div class="col-md-6 col-lg-3"><b>Purchase Date:</b>           {{ \Carbon\Carbon::parse($purchaseinvoice->created_at)->format('h:i A d-m-Y') }}</div>
            ...
            <div class="row">
              <div class="col-12 table-responsive">
                <table class="table table-bordered">
                  ...
                  @foreach ($purchasedata as $key => $product)
    <tr>
        <td>{{ $key + 1 }}</td>
        <td>
...
@endforeach
            ...
            <div class="row">
              <div class="col-12 text-right">
                  <div>
                      <p>Total amount  :  {{$purchaseinvoice->total_price}}</p>
                      <p>Paid amount :   {{$purchaseinvoice->pay}}</p>
                  </div>
                  <div class="total-payment">
                    <div class="total-payment">
                        @if ($purchaseinvoice->due == 0)
        <h3><b>Total Paid :</b> {{$purchaseinvoice->pay}}</h3>
    @elseif ($purchaseinvoice->due > 0)
        <h3><b>Total Due :</b> {{$purchaseinvoice->due}}</h3>
    @endif
                    </div>
                  </div>
              </div>
