                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add & Manage Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                @if (empty($editdata))
                                    {!! Form::open(['route' => ['manage-category.store'], 'method' => 'POST']) !!}
                                ...
                                @else
                                    {{ Form::open(['route' => ['manage-category.update', $editdata->id], 'method' => 'PUT', 'files' => true]) }}
                                                    ...
                                                    <td>
                                                        <div class="btn-group mb-5">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <form
                                                                    action="{{ route('manage-category.destroy', $categories->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <a type="submit"
