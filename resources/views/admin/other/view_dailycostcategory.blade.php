            ...
            <section class="content">
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                @if (!empty($editdata))
                                    <h4 class="box-title">Edit Daily Cost Category</h4>
                                @else
                                    <h4 class="box-title">Add Daily Cost Category</h4>
                                @endif
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                @if (empty($editdata))
                                    {!! Form::open(['route' => ['manage-daily-cost-category.store'], 'method' => 'POST']) !!}
                                                ...
                                                <div class="col-8 form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="name[]" class="form-control"
                                                            value="" required placeholder="Enter Category Name">
                                                    </div>
                                                </div>
                                ...
                                @else
                                    {{ Form::open(['route' => ['manage-daily-cost-category.update', $editdata->id], 'method' => 'PUT', 'files' => true]) }}
                    ...
                    <div class="col-xl-6">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daily Cost Category</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
